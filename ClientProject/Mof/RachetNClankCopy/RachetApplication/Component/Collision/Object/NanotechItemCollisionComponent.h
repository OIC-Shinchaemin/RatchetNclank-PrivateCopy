#ifndef MY_NanotechItem_COLLISION_COMPONENT_H
#define MY_NanotechItem_COLLISION_COMPONENT_H
...
namespace my {
class NanotechItemCollisionComponent : public my::CollisionComponent {
...
#endif // !MY_NanotechItem_COLLISION_COMPONENT_H