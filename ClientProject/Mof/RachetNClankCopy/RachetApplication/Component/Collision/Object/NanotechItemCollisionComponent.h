#ifndef RACHET_NanotechItem_COLLISION_COMPONENT_H
#define RACHET_NanotechItem_COLLISION_COMPONENT_H
...
namespace rachet {
class NanotechItemCollisionComponent : public rachet::CollisionComponent {
...
#endif // !RACHET_NanotechItem_COLLISION_COMPONENT_H