#ifndef RACHET_BOLT_COLLISION_COMPONENT_H
#define RACHET_BOLT_COLLISION_COMPONENT_H
...
namespace rachet {
class BoltCollisionComponent : public rachet::CollisionComponent {
...
#endif // !RACHET_BOLT_COLLISION_COMPONENT_H