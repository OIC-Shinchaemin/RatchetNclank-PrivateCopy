#ifndef MY_BulletItem_COLLISION_COMPONENT_H
#define MY_BulletItem_COLLISION_COMPONENT_H
...
namespace my {
class BulletItemCollisionComponent : public my::CollisionComponent {
...
#endif // !MY_BulletItem_COLLISION_COMPONENT_H