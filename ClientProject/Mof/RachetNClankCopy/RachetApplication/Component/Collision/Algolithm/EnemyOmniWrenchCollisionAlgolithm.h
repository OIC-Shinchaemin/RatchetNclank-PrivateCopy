#ifndef MY_ENEMY_OMNI_WRENCH_COLLISION_ALGOLITHM_H
#define MY_ENEMY_OMNI_WRENCH_COLLISION_ALGOLITHM_H
...
namespace my {
class EnemyOmniWrenchCollisionAlgolithm : public my::CollisionAlgolithm {
...
#endif // !MY_ENEMY_OMNI_WRENCH_COLLISION_ALGOLITHM_H