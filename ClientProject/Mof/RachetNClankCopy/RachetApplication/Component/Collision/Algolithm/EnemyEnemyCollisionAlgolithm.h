#ifndef MY_ENEMY_ENEMY_COLLISION_ALGOLITHM_H
#define MY_ENEMY_ENEMY_COLLISION_ALGOLITHM_H
...
namespace my {
class EnemyEnemyCollisionAlgolithm : public my::CollisionAlgolithm {
...
#endif // !MY_ENEMY_ENEMY_COLLISION_ALGOLITHM_H