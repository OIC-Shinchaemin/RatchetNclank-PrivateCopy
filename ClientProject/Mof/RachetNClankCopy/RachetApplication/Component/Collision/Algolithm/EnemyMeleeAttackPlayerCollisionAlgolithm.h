#ifndef MY_ENEMY_MELEE_ATTACK_PLAYER_COLLISION_ALGOLITHM_H
#define MY_ENEMY_MELEE_ATTACK_PLAYER_COLLISION_ALGOLITHM_H
...
namespace my {
class EnemyMeleeAttackPlayerCollisionAlgolithm : public my::CollisionAlgolithm {
...
#endif // !MY_ENEMY_MELEE_ATTACK_PLAYER_COLLISION_ALGOLITHM_H