#ifndef RACHET_ENEMY_PLAYER_COLLISION_ALGOLITHM_H
#define RACHET_ENEMY_PLAYER_COLLISION_ALGOLITHM_H
...
namespace rachet {
class EnemyPlayerCollisionAlgolithm: public rachet::CollisionAlgolithm {
...
#endif // !RACHET_ENEMY_PLAYER_COLLISION_ALGOLITHM_H