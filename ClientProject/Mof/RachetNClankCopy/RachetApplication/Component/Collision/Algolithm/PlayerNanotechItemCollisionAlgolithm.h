#ifndef RACHET_PLAYER_NanotechItem_COLLISION_ALGOLITHM_H
#define RACHET_PLAYER_NanotechItem_COLLISION_ALGOLITHM_H
...
namespace rachet {
class PlayerNanotechItemCollisionAlgolithm : public rachet::CollisionAlgolithm {
...
#endif // !RACHET_PLAYER_NanotechItem_COLLISION_ALGOLITHM_H