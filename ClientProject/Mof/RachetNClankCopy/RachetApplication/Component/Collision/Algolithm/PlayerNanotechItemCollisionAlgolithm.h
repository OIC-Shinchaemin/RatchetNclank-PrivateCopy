#ifndef MY_PLAYER_NanotechItem_COLLISION_ALGOLITHM_H
#define MY_PLAYER_NanotechItem_COLLISION_ALGOLITHM_H
...
namespace my {
class PlayerNanotechItemCollisionAlgolithm : public my::CollisionAlgolithm {
...
#endif // !MY_PLAYER_NanotechItem_COLLISION_ALGOLITHM_H