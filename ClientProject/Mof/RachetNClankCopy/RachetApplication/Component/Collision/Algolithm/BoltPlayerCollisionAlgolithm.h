#ifndef MY_BOLT_PLAYER_COLLISION_ALGOLITHM_H
#define MY_BOLT_PLAYER_COLLISION_ALGOLITHM_H
...
namespace my {
class BoltPlayerCollisionAlgolithm : public my::CollisionAlgolithm {
...
#endif // !MY_BOLT_PLAYER_COLLISION_ALGOLITHM_H