#ifndef RACHET_PLAYER_SHIP_COLLISION_ALGOLITHM_H
#define RACHET_PLAYER_SHIP_COLLISION_ALGOLITHM_H
...
namespace rachet {
class PlayerShipCollisionAlgolithm : public rachet::CollisionAlgolithm {
...
#endif // !RACHET_PLAYER_SHIP_COLLISION_ALGOLITHM_H