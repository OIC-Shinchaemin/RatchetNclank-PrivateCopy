#ifndef MY_PLAYER_SHIP_COLLISION_ALGOLITHM_H
#define MY_PLAYER_SHIP_COLLISION_ALGOLITHM_H
...
namespace my {
class PlayerShipCollisionAlgolithm : public my::CollisionAlgolithm {
...
#endif // !MY_PLAYER_SHIP_COLLISION_ALGOLITHM_H