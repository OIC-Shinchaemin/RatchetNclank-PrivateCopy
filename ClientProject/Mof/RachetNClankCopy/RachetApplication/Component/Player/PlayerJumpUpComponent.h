#ifndef RACHET_PLAYER_JUMP_UP_COMPONENT_H
#define RACHET_PLAYER_JUMP_UP_COMPONENT_H
...
namespace rachet {
class PlayerJumpUpComponent : public rachet::PlayerActionComponent {
    using super = rachet::PlayerActionComponent;
    using This = rachet::PlayerJumpUpComponent;
    struct InputInfo {
        Mof::CVector2 in;
...
#endif // !RACHET_PLAYER_JUMP_UP_COMPONENT_H