#ifndef MY_PLAYER_ACTION_COMPONENT_H
#define MY_PLAYER_ACTION_COMPONENT_H
...
namespace my {
class PlayerActionComponent : public my::ActionComponent {
...
#endif // !MY_PLAYER_ACTION_COMPONENT_H