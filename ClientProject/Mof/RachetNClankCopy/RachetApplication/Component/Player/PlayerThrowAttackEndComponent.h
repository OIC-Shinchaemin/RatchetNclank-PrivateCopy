#ifndef MY_PLAYER_THROW_ATTACK_END_COMPONENT_H
#define MY_PLAYER_THROW_ATTACK_END_COMPONENT_H
...
namespace my {
class PlayerThrowAttackEndComponent : public my::PlayerActionComponent {
...
#endif // !MY_PLAYER_THROW_ATTACK_END_COMPONENT_H