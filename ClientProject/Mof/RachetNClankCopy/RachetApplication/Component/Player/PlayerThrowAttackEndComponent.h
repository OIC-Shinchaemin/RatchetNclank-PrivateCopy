#ifndef RACHET_PLAYER_THROW_ATTACK_END_COMPONENT_H
#define RACHET_PLAYER_THROW_ATTACK_END_COMPONENT_H
...
namespace rachet {
class PlayerThrowAttackEndComponent : public rachet::PlayerActionComponent {
...
#endif // !RACHET_PLAYER_THROW_ATTACK_END_COMPONENT_H