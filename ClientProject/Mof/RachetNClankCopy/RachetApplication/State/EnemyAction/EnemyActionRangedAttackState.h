#ifndef STATE_ENEMY_ACTION_RANGED_ATTACK_STATE_H
#define STATE_ENEMY_ACTION_RANGED_ATTACK_STATE_H
...
namespace state {
class EnemyActionRangedAttackState : public state::EnemyActionState {
...
private:
    ...
    //! 攻撃
    std::weak_ptr<my::EnemyRangedAttackComponent> _attack_com;
public:
    /// <summary>
    /// コンストラクタ
    /// </summary>
    EnemyActionRangedAttackState();
    /// <summary>
    /// デストラクタ
    /// </summary>
    virtual ~EnemyActionRangedAttackState();
    /// <summary>
    /// セッター
    /// </summary>
...
#endif // !STATE_ENEMY_ACTION_RANGED_ATTACK_STATE_H