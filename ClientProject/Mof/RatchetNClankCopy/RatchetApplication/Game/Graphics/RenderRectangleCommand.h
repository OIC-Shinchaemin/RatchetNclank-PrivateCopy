#ifndef RATCHET_GAME_GRAPHICS_RENDER_RECTANGLE_COMMAND_H
#define RATCHET_GAME_GRAPHICS_RENDER_RECTANGLE_COMMAND_H
...
#endif // !RATCHET_GAME_GRAPHICS_RENDER_RECTANGLE_COMMAND_H