#ifndef RATCHET_SHOP_COLLISION_COMPONENT_H
#define RATCHET_SHOP_COLLISION_COMPONENT_H
...
namespace ratchet {
class ShopCollisionComponent : public ratchet::CollisionComponent {
...
#endif // !RATCHET_SHOP_COLLISION_COMPONENT_H