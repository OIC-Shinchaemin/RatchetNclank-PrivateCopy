#ifndef RATCHET_COMPONENT_COLLISION_SCARECROW_COLLISION_COMPONENT_H
#define RATCHET_COMPONENT_COLLISION_SCARECROW_COLLISION_COMPONENT_H
...
public:
    ...
    ScarecrowCollisionComponent(int priority);
    /// <summary>
    /// コピーコンストラクタ
    /// </summary>
    /// <param name="obj"></param>
    ScarecrowCollisionComponent(const ScarecrowCollisionComponent& obj);
    /// <summary>
    /// デストラクタ
    /// </summary>
    virtual ~ScarecrowCollisionComponent();
    /// <summary>
    /// ゲッター
    /// </summary>
    /// <param name=""></param>
...
#endif // !RATCHET_COMPONENT_COLLISION_SCARECROW_COLLISION_COMPONENT_H