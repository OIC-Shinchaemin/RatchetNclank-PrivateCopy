#ifndef RATCHET_COMPONENT_COLLISION_KING_COLLISION_COMPONENT_H
...
class KingCollisionComponent : public ratchet::component::collision::CollisionComponent {
...
public:
    ...
    KingCollisionComponent(int priority);
    /// <summary>
    /// コピーコンストラクタ
    /// </summary>
    /// <param name="obj"></param>
    KingCollisionComponent(const KingCollisionComponent& obj);
    /// <summary>
    /// デストラクタ
    /// </summary>
    virtual ~KingCollisionComponent();
    /// <summary>
    /// ゲッター
    /// </summary>
    /// <param name=""></param>
...
#endif // !RATCHET_COMPONENT_COLLISION_KING_COLLISION_COMPONENT_H