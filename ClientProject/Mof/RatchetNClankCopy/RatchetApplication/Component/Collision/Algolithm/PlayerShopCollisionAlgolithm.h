#ifndef RATCHET_PLAYER_SHOP_COLLISION_ALGOLITHM_H
#define RATCHET_PLAYER_SHOP_COLLISION_ALGOLITHM_H
...
namespace ratchet {
class PlayerShopCollisionAlgolithm : public ratchet::CollisionAlgolithm {
...
#endif // !RATCHET_PLAYER_SHOP_COLLISION_ALGOLITHM_H