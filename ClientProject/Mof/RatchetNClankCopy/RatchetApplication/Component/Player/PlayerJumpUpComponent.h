#ifndef RATCHET_PLAYER_JUMP_UP_COMPONENT_H
#define RATCHET_PLAYER_JUMP_UP_COMPONENT_H
...
namespace ratchet {
class PlayerJumpUpComponent : public ratchet::PlayerActionComponent {
    using super = ratchet::PlayerActionComponent;
    using This = ratchet::PlayerJumpUpComponent;
    struct InputInfo {
        Mof::CVector2 in;
...
#endif // !RATCHET_PLAYER_JUMP_UP_COMPONENT_H