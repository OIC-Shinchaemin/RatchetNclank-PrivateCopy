#ifndef RATCHET_PLAYER_THROW_ATTACK_END_COMPONENT_H
#define RATCHET_PLAYER_THROW_ATTACK_END_COMPONENT_H
...
namespace ratchet {
class PlayerThrowAttackEndComponent : public ratchet::PlayerActionComponent {
...
#endif // !RATCHET_PLAYER_THROW_ATTACK_END_COMPONENT_H