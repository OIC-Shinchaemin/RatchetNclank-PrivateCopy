#ifndef RATCHET_BEHAVIOUR_CHANGE_PATROL_NODE_EXECUTOR_H
#define RATCHET_BEHAVIOUR_CHANGE_PATROL_NODE_EXECUTOR_H
...
namespace ratchet {
namespace behaviour {
class ChangePatrolNodeExecutor : public ratchet::behaviour::ActionNodeExecutor {
...
private:
    //! 実行引数
    ratchet::behaviour::ChangePatrolNodeExecutor::NodeArgs _node_args;
public:
    /// <summary>
    /// コンストラクタ
    /// </summary>
    /// <param name="node"></param>
    ChangePatrolNodeExecutor(const ratchet::behaviour::NodePtr& node) :
        super(node),
        _node_args() {
    }
    /// <summary>
...
#endif // !RATCHET_BEHAVIOUR_CHANGE_PATROL_NODE_EXECUTOR_H