#ifndef RATCHET_BEHAVIOUR_SEQUENCER_NODE_EXECUTOR_H
#define RATCHET_BEHAVIOUR_SEQUENCER_NODE_EXECUTOR_H
...
public:
    ...
    SequencerNodeExecutor(const ratchet::behaviour::CompositeNodePtr& node) :
        super(node) {
    }
    /// <summary>
    /// デストラクタ
...
#endif // !RATCHET_BEHAVIOUR_SEQUENCER_NODE_EXECUTOR_H